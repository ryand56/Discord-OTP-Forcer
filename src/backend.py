	...
	try:
		...
		while (True):
			...
			# The entered TOTP code is invalid. Wait a few seconds, then try again.
				...
				sleep_duration_seconds = secrets.choice(range(4, 12))
			...
			try:
				...
				loginTest = driver.find_element(by=By.CLASS_NAME, value='app__160d8') # Will need a better way to detect the presence of a class.
				driver.implicitly_wait(1)
